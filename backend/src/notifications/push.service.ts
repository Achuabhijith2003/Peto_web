...
import { PushSubscriptionInput } from "./notification.types";
...
export async function sendPushNotificationToUser(userId: string, title: string, body: string, url: string = "/social") {
    try {
