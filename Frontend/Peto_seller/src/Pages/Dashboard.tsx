...
import {
  Payment, TrendingUp, Inventory2, Warning,LocalShippingOutlined,StarBorderOutlined,ShoppingBagOutlined,Reviews,ConfirmationNumberOutlined,InsightsOutlined,SettingsAccessibilityOutlined
...
export default function Dashboard() {
  ...
  return (
    <div className=" animate-in select-none">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/20 shadow-level-1 flex justify-between items-center">
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-tertiary flex items-center font-bold">
              <TrendingUp className="material-symbols-outlined text-xs mr-0.5" />+12.5% this month
            </p>
          </div>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/20 shadow-level-1 flex justify-between items-center">
          ...
          <div className="w-12 h-12 bg-primary/10 text-primary rounded-xl flex items-center justify-center">
            <Inventory2 className="material-symbols-outlined text-2xl fill-icon" />
          </div>
        </div>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/20 shadow-level-1 flex justify-between items-center">
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-error flex items-center font-bold">
              ...
              <Warning className="material-symbols-outlined text-xs mr-0.5" />Needs shipping
            </p>
          </div>
          <div className="w-12 h-12 bg-primary/10 text-primary rounded-xl flex items-center justify-center">
            < LocalShippingOutlined className="material-symbols-outlined text-2xl fill-icon"/>
          </div>
        </div>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/20 shadow-level-1 flex justify-between items-center">
          ...
          <div className="w-12 h-12 bg-primary/10 text-primary rounded-xl flex items-center justify-center">
            <StarBorderOutlined className="material-symbols-outlined text-2xl fill-icon"/>
          </div>
        </div>
      </section>
...
<div className="bg-surface-container-lowest p-6 md:p-8 rounded-xl border border-outline-variant/20 shadow-level-1 flex flex-col justify-between">
  <div>
    <h3 className="font-headline-md text-body-lg font-bold text-on-surface mb-6">
      Recent Alerts
    </h3>
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-4 border-b border-outline-variant/10 pb-4">
        ...
        <div className="w-11 h-11 shrink-0 bg-primary/10 text-primary rounded-xl flex items-center justify-center">
          <ShoppingBagOutlined className="text-2xl" />
        </div>
        {/* Text Container - added flex-1 and min-w-0 to handle text wrapping properly */}
        <div className="flex-1 min-w-0">
          <p className="font-label-md text-on-surface font-semibold text-sm truncate">
            New Order #8402
          </p>
          <p className="text-body-sm text-on-surface-variant truncate">
            Buddy's Salmon Kibble • $45.99
          </p>
      ...
      {/* Alert 2: Low Stock */}
      <div className="flex items-center gap-4 border-b border-outline-variant/10 pb-4">
        <div className="w-11 h-11 shrink-0 bg-error/10 text-error rounded-xl flex items-center justify-center">
      ...
      <div className="flex items-center gap-4">
        <div className="w-11 h-11 shrink-0 bg-tertiary/10 text-primary rounded-xl flex items-center justify-center">
          <Reviews className="material-symbols-outlined text-2xl"/>
        </div>
        <div className="flex-1 min-w-0">
          <p className="font-label-md text-on-surface font-semibold text-sm truncate">
            New 5-star Review
          ...
          <p className="text-body-sm text-on-surface-variant truncate">
            "Luna loves the chew toy!" - Jane D.
          </p>
          <span className="text-[10px] text-outline font-semibold block mt-0.5">
            3 hours ago
          </span>
  ...
  <button className="w-full py-2.5 mt-6 text-secondary hover:bg-secondary/5 font-bold rounded-lg transition-colors border border-secondary/20 text-label-sm">
    View All Activity
  </button>
</div>
      </section>
      ...
      <section className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/20 shadow-level-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            <Inventory2 className="material-symbols-outlined text-3xl text-primary font-bold" />
          ...
          <button
            ...
            className="flex flex-col items-center justify-center p-4 rounded-xl border border-outline-variant/20 hover:bg-surface-container transition-all gap-2 text-center"
          >
            <ConfirmationNumberOutlined className="material-symbols-outlined text-3xl text-primary font-bold"/>
          ...
          <button
            ...
            className="flex flex-col items-center justify-center p-4 rounded-xl border border-outline-variant/20 hover:bg-surface-container transition-all gap-2 text-center"
          >
            <InsightsOutlined className="material-symbols-outlined text-3xl text-primary font-bold"/>
          ...
          <button
            ...
            className="flex flex-col items-center justify-center p-4 rounded-xl border border-outline-variant/20 hover:bg-surface-container transition-all gap-2 text-center"
          >
            <SettingsAccessibilityOutlined className="material-symbols-outlined text-3xl text-primary font-bold"/>
